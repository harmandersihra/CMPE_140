module datapath
(input clk, rst, pc_src, jump, we_reg, alu_src, dm2reg, [2:0] alu_ctrl, reg_dst, mult_sel, [4:0] ra3, [31:0] instr, rd_dm, output zero, [31:0] pc_current, alu_out, wd_dm, rd3);
    wire [4:0]  rf_wa;
    wire [31:0] pc_plus4, pc_pre, pc_next, sext_imm, ba, bta, jta, alu_pa, alu_pb, wd_rf;
    wire [63:0] multi_out;
    wire [31:0] lo_out, hi_out, multi_mux_out, jr_mux_out;
    ...
    regfile    rf         (clk, we_reg, instr[25:21], instr[20:16], ra3, rf_wa, multi_mux_out, alu_pa, wd_dm, rd3);
    ...
    // --- MULTU Logic --- //
    mult multu (alu_pa, wd_dm, multi_out);
    dreg2 lo (clk, rst, en, multi_out[31:0], lo_out);
    dreg2 hi (clk, rst, en, multi_out[63:32], hi_out);
    mux4 #(32) multi_mux(mult_sel, pc_plus4, wd_rf, lo_out, hi_out, multi_mux_out);
endmodule