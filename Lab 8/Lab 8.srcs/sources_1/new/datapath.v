module datapath(
    ...
    adder      pc_plus_br (pc_currentF, ba, btaD);
    mux2 #(32) pc_src_mux (pc_srcD, pc_plus4F, btaD, pc_pre);
    ...
    signext    se         (instrD[15:0], sext_immD);
    ...
    mux4 #(32) mult_mux(mult_selW, pc_plus4W, wd_rfW, lo_outW, hi_outW, rd_rfW);

    // --- Pipeline registers --- //
    register #(64)  d_reg(.D({instrF, pc_plus4F}),
                          .Q({instrD, pc_plus4D}),
